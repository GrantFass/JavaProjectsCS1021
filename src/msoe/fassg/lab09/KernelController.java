 ...
 * Course: CS 1021 - 021
 * Winter 2019
 * KernelController purpose: the secondary controller class for Lab 9
 *
 * @author fassg
...
public class KernelController {
     ...
     */
    private Lab9Controller otherController;
    /**
     ...
     */
    private double[] kernel = new double[kernelLength];
     ...
     */
    public void setOtherController(Lab9Controller otherController) {
    ...
    private void updateKernel() throws NumberFormatException{
        ...
        kernel[kernelLength - 4] = textFieldToDouble(middleRightTextField);
        kernel[kernelLength - 3] = textFieldToDouble(bottomLeftTextField);
        kernel[kernelLength - 2] = textFieldToDouble(bottomMiddleTextField);
        kernel[kernelLength - 1] = textFieldToDouble(bottomRightTextField);
    }
